...
def build_rewrite_instructions(request: RewriteRequest) -> str:
    ...
    if request.iteration > 1 or request.prior_score > (request.target_score + 0.20):
        escalation = (
            ...
            "- remove generic slogans, platitudes, and speechwriter polish\n"
            "- replace abstractions with concrete specifics or plain phrasing\n"
            ...
            "- avoid campaign-style or ceremonial language\n"
        )
    return (
        ...
        "- Avoid repeated motivational framing, abstract civic slogans, and tidy parallel constructions.\n"
